...
func NodeSpecFromPanel(nc *panel.NodeConfig) *NodeSpec {
	...
	return &NodeSpec{
		...
		PrivateAllowCIDRs:   cloneStringSlice(nc.PrivateAllowCIDRs),
		ACLResolveDomains:   normalizeResolveDomains(nc.ACLResolveDomains),
		CertConfig:          certCfg,
		AutoTLS:             nc.AutoTLS,
		Domain:              nc.Domain,
		Cipher:              nc.Cipher,
...
func (n *NodeSpec) ToPanel() *panel.NodeConfig {
	...
	return &panel.NodeConfig{
		...
		CustomRouteRules:    customRouteRules,
		PrivateAllowCIDRs:   cloneStringSlice(n.PrivateAllowCIDRs),
		ACLResolveDomains:   cloneStringSlice(n.ACLResolveDomains),
		CertConfig:          certCfg,
		AutoTLS:             n.AutoTLS,
		Domain:              n.Domain,
		Cipher:              n.Cipher,
